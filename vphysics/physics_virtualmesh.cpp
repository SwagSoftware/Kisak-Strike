...
//CThreadLocalPtr< CUtlVector<CPhysCollideVirtualMesh *> > g_pMeshFrameLocks; // lwss- changed to macro version
...
void CMeshInstance::Init( const virtualmeshlist_t &list )
{
	...
	Assert( (intptr_t(m_pMemory) & 15) == 0 );	// make sure it is aligned
